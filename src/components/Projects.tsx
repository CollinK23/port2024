...
const Projects = () => {
  return (
    <div id="projects" className="w-full min-h-screen py-32 relative -mt-32">
      ...
      <div className=" max-w-[1140px] flex justify-center flex-col mx-auto relative z-10">
        <div className="max-w-[1100px] justify-left w-full mx-auto font-medium text-left text-white font-semibold mb-[50px] text-[48px] sm:px-0 px-8">
          Projects
        </div>
